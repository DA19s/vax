    ...
    FaqItem(
      ...
      questions: [
        ...
        FaqQuestion(
          ...
          answer: 'Oui, vous recevrez des notifications push quelques jours avant chaque rendez-vous. Assurez-vous d\'avoir activé les notifications dans les paramètres de votre téléphone pour l\'application VaxCare.',
        ),
        FaqQuestion(
    ...
    FaqItem(
      ...
      questions: [
        FaqQuestion(
          ...
          answer: 'Vérifiez que les notifications sont activées dans les paramètres de votre téléphone pour l\'application VaxCare. Les notifications sont envoyées pour les rendez-vous programmés, les vaccins manqués, les nouvelles campagnes et les conseils de santé.',
        ),
        FaqQuestion(
